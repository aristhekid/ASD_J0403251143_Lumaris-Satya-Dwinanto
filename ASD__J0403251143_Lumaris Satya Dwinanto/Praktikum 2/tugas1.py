#================================================================
# Tugas Hands On 1 - Modul 1
# Sistem Stok Barang Kantin (Berbabsis file txt)
...
def baca_stok(nama_file):
    ...
    """
    stok_dict = {}
#TO DO: Buka file dan baca seluruh baris
...
def tampilkan_semua(stok_dict):
    ...
    for kode in sorted(stok_dict.keys()):
        nama = stok_dict[kode]["nama"]
        stok = stok_dict[kode]["stok"]
        print(f"{kode:<10} | {nama:<15} | {int(stok):>5}")
